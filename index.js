...
const tanksElements = tanksData
  .map(
    (tank) => `<li class="tanks-item">
                ...
                <p class="tanks-text" data-describtion="${tank.description}">Price: $${tank.price}</p>
            </li>`
  )
  .join("");
